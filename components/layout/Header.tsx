  ...
  return (
    <header className="relative z-20">
        ...
        <div className="hidden lg-custom:block">
          ...
          <div className="flex gap-6 flex-col absolute -bottom-10 left-0 right-0 justify-center items-center">
            ...
            <Link href={"/"} className="flex justify-center items-center relative" style={{ filter: 'drop-shadow(0 0 20px rgba(147, 51, 234, 0.6)) drop-shadow(0 0 60px rgba(147, 51, 234, 0.2))' }} >
              ...
              <Image src={headerTextBgImage} alt="header img" className="mx-auto w-full h-full absolute " />
                  <h1 className="px-14 py-12 text-4xl text-indigo-300 font-bold text-center relative"  style={{ fontFamily: '"Press Start 2P", "Courier New", monospace', letterSpacing: '0.2em', textShadow: '2px 2px 0px rgba(0,0,0,0.5)' }}>MAUVE STEP</h1>
            </Link>
